execute if score @s calc-1 matches ..80 if score @s outsight matches 0 positioned over world_surface positioned ~ ~-20 ~ unless entity @s[dy=384] run return run function subdatafive:heat/collect_env_underground
