...
execute if data entity @s equipment.chest.components."minecraft:custom_data"{Hydrate:true} if data entity @s equipment.legs.components."minecraft:custom_data"{Hydrate:true} if data entity @s equipment.feet.components."minecraft:custom_data"{Hydrate:true} if data entity @s equipment.head.components."minecraft:custom_data"{Hydrate:true} if items entity @s armor.* *[minecraft:custom_data~{OverHydrate:true}] unless dimension minecraft:the_nether run return run damage @s 0.9 minecraft:drown
#Legacy
