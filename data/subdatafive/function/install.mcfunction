...
data modify storage subdatafive:main GearStationRecipes append value {BaseID:"netherrack_leggings",Add:{id:"prism_soul_sand",count:8,Text:"8x Soul Ore"},Result:{id:"soul_sand_leggings",Item:{id:"feather",components:{"minecraft:dyed_color":2826007,"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color"]},"minecraft:custom_data":{TempModifier:4,OverHydrate:1},item_model:"minecraft:leather_leggings","minecraft:item_name":"Soul Sand Leggings",attribute_modifiers:[{id:"minecraft:armor.boots",amount:4,type:"minecraft:armor",operation:"add_value",slot:"legs"}],"minecraft:max_damage":228,"minecraft:damage":0,"!minecraft:max_stack_size":{},"minecraft:equippable":{slot:"legs",asset_id:"minecraft:leather",equip_sound:"minecraft:item.armor.equip_leather"},"minecraft:lore":[{text:"Spooky ... but keeps warm.",color:"dark_gray"}],repairable:{items:["minecraft:soul_sand","minecraft:soul_soil"]}}}}}
data modify storage subdatafive:main GearStationRecipes append value {BaseID:"netherrack_chestplate",Add:{id:"prism_soul_sand",count:8,Text:"8x Soul Ore"},Result:{id:"soul_sand_chestplate",Item:{id:"feather",components:{"minecraft:dyed_color":2826007,"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color"]},"minecraft:custom_data":{TempModifier:4,OverHydrate:1},item_model:"minecraft:leather_chestplate","minecraft:item_name":"Soul Sand Chestplate",attribute_modifiers:[{id:"minecraft:armor.boots",amount:5,type:"minecraft:armor",operation:"add_value",slot:"chest"}],"minecraft:max_damage":232,"minecraft:damage":0,"!minecraft:max_stack_size":{},"minecraft:equippable":{slot:"chest",asset_id:"minecraft:leather",equip_sound:"minecraft:item.armor.equip_leather"},"minecraft:lore":[{text:"Spooky ... but keeps warm.",color:"dark_gray"}],repairable:{items:["minecraft:soul_sand","minecraft:soul_soil"]}}}}}
data modify storage subdatafive:main GearStationRecipes append value {BaseID:"netherrack_helmet",Add:{id:"prism_soul_sand",count:8,Text:"8x Soul Ore"},Result:{id:"soul_sand_helmet",Item:{id:"feather",components:{"minecraft:dyed_color":2826007,"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color"]},"minecraft:custom_data":{TempModifier:4,OverHydrate:1},item_model:"minecraft:soul_sand","minecraft:item_name":"Soul Sand Chestplate",attribute_modifiers:[{id:"minecraft:armor.boots",amount:2,type:"minecraft:armor",operation:"add_value",slot:"head"}],"minecraft:max_damage":218,"minecraft:damage":0,"!minecraft:max_stack_size":{},"minecraft:equippable":{slot:"head",equip_sound:"minecraft:item.armor.equip_leather"},"minecraft:lore":[{text:"Spooky ... but keeps warm.",color:"dark_gray"}],repairable:{items:["minecraft:soul_sand","minecraft:soul_soil"]}}}}}
#Thirst Bar
