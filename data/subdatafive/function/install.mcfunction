...
data modify storage subdatafive:main GearStationRecipes append value {BaseID:"soul_sand_leggings",Add:{id:"netherite_nugget",count:4,Text:"4x Netherite Nugget"},Result:{id:"soulite_leggings",Item:{id:"feather",components:{"minecraft:dyed_color":5983560,"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color"]},"minecraft:custom_data":{TempModifier:4,OverHydrate:true},item_model:"minecraft:leather_leggings","minecraft:item_name":"Soulite Leggings","minecraft:attribute_modifiers":[{id:"minecraft:armor.leggings",amount:6,type:"minecraft:armor",operation:"add_value",slot:"legs"},{id:"minecraft:armor.leggings",amount:3,type:"minecraft:armor_toughness",operation:"add_value",slot:"legs"},{type:"minecraft:knockback_resistance",id:"minecraft:armor.leggings",amount:0.1,operation:"add_value",slot:"legs"}],"minecraft:max_damage":555,"minecraft:damage":0,"!minecraft:max_stack_size":{},"minecraft:equippable":{slot:"legs",asset_id:"minecraft:leather",equip_sound:"minecraft:item.armor.equip_netherite"},"minecraft:lore":[{text:"Stay Protected!",color:"dark_gray"}],repairable:{items:"#minecraft:soul_fire_base_blocks"},"minecraft:damage_resistant":{types:"#minecraft:is_fire"}}}}}
data modify storage subdatafive:main GearStationRecipes append value {BaseID:"soul_sand_chestplate",Add:{id:"netherite_nugget",count:4,Text:"4x Netherite Nugget"},Result:{id:"soulite_chestplate",Item:{id:"feather",components:{"minecraft:dyed_color":5983560,"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color"]},"minecraft:custom_data":{TempModifier:4,OverHydrate:true},item_model:"minecraft:leather_chestplate","minecraft:item_name":"Soulite Chestplate","minecraft:attribute_modifiers":[{id:"minecraft:armor.chestplate",amount:8,type:"minecraft:armor",operation:"add_value",slot:"chest"},{id:"minecraft:armor.chestplate",amount:3,type:"minecraft:armor_toughness",operation:"add_value",slot:"chest"},{type:"minecraft:knockback_resistance",id:"minecraft:armor.chestplate",amount:0.1,operation:"add_value",slot:"chest"}],"minecraft:max_damage":592,"minecraft:damage":0,"!minecraft:max_stack_size":{},"minecraft:equippable":{slot:"chest",asset_id:"minecraft:leather",equip_sound:"minecraft:item.armor.equip_netherite"},"minecraft:lore":[{text:"Stay Protected!",color:"dark_gray"}],repairable:{items:"#minecraft:soul_fire_base_blocks"},"minecraft:damage_resistant":{types:"#minecraft:is_fire"}}}}}
data modify storage subdatafive:main GearStationRecipes append value {BaseID:"soul_sand_helmet",Add:{id:"netherite_nugget",count:4,Text:"4x Netherite Nugget"},Result:{id:"soulite_helmet",Item:{id:"feather",components:{"minecraft:custom_data":{TempModifier:4,OverHydrate:true},item_model:"minecraft:soul_soil","minecraft:item_name":"Soulite Helmet","minecraft:attribute_modifiers":[{id:"minecraft:armor.helmet",amount:3,type:"minecraft:armor",operation:"add_value",slot:"head"},{id:"minecraft:armor.helmet",amount:3,type:"minecraft:armor_toughness",operation:"add_value",slot:"head"},{type:"minecraft:knockback_resistance",id:"minecraft:armor.helmet",amount:0.1,operation:"add_value",slot:"head"}],"minecraft:max_damage":407,"minecraft:damage":0,"!minecraft:max_stack_size":{},"minecraft:equippable":{slot:"head",equip_sound:"minecraft:item.armor.equip_netherite"},"minecraft:lore":[{text:"Stay Protected!",color:"dark_gray"}],repairable:{items:"#minecraft:soul_fire_base_blocks"},"minecraft:damage_resistant":{types:"#minecraft:is_fire"}}}}}
...
data modify storage subdatafive:main GearStationRecipes append value {BaseID:"overlord_chestplate",Add:{id:"membrane_elytra",count:1,Text:"+ Membrane Elytra"},Result:{id:"flight_overlord_chestplate",Item:{components:{"minecraft:item_name":"Flight Overlord Chestplate","minecraft:glider":{}}}}}
#Thirst Bar
