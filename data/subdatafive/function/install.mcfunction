...
#Storage
data modify storage subdatafive:main GearStationRecipes set value [{BaseID:"agaminor_blade",Add:{id:"diorite_crystal",count:16,Text:"16x Diorite Crystal"},Result:{id:"agaminor_sword",Item:{id:"minecraft:iron_sword",components:{"minecraft:attribute_modifiers":[{type:"minecraft:attack_damage",id:"subdatafive:agaminor",amount:1.4,operation:"add_value",slot:"mainhand"},{type:"minecraft:gravity",id:"subdatafive:agaminor",amount:0.5,operation:"add_multiplied_base",slot:"mainhand"},{type:"minecraft:movement_speed",id:"subdatafive:agaminor",amount:-0.1,operation:"add_multiplied_base",slot:"mainhand",display:{type:"hidden"}},{type:"minecraft:step_height",id:"subdatafive:agaminor",amount:0.4,operation:"add_value",slot:"mainhand",display:{type:"hidden"}},{type:"minecraft:sweeping_damage_ratio",id:"subdatafive:agaminor",amount:0.25,operation:"add_value",slot:"mainhand",display:{type:"default"}}],"minecraft:blocks_attacks":{block_delay_seconds:1,disable_cooldown_scale:0.8,damage_reductions:[],item_damage:{threshold:0,base:-1,factor:1},bypassed_by:"#minecraft:is_projectile"},"minecraft:enchantable":{value:15},"minecraft:item_model":"minecraft:amethyst_shard","minecraft:item_name":"Sword of Agaminor","minecraft:max_damage":1387,"minecraft:repairable":{items:"minecraft:amethyst_shard"},"minecraft:lore":[]}}}},{BaseID:"agaminor_blade",Add:{id:"husk_dye",count:32,Text:"32x Husk Dye"}},{BaseID:"prismarine_helmet",Add:{id:"obsidian_shard",count:16,Text:"16x Obsidian Shard"},Result:{id:"prismaridian_helmet",Item:{id:"netherite_helmet",components:{"minecraft:custom_data":{TempModifier:-3,OverHydrate:true},item_model:"minecraft:obsidian","minecraft:item_name":"Prismaridian Helmet","minecraft:attribute_modifiers":[{id:"minecraft:armor.helmet",amount:3,type:"minecraft:armor",operation:"add_value",slot:"head"},{id:"minecraft:armor.helmet",amount:2,type:"minecraft:armor_toughness",operation:"add_value",slot:"head"}],"minecraft:max_damage":482,"minecraft:equippable":{slot:"head",equip_sound:"minecraft:item.armor.equip_diamond"},"minecraft:lore":[{text:"Wet as a Guardian, tough",color:"dark_gray"},{text:"as ... those shiny stones.",color:"dark_gray"}],"!damage_resistant":{},"minecraft:repairable":{items:["minecraft:obsidian","minecraft:prismarine_crystals"]}}}}},{BaseID:"prismarine_chestplate",Add:{id:"obsidian_shard",count:16,Text:"16x Obsidian Shard"},Result:{id:"prismaridian_chestplate",Item:{id:"netherite_chestplate",components:{"minecraft:dyed_color":1051938,"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color"]},"minecraft:custom_data":{TempModifier:-3,OverHydrate:true},item_model:"minecraft:leather_chestplate","minecraft:item_name":"Prismaridian Chestplate","minecraft:attribute_modifiers":[{id:"minecraft:armor.chestplate",amount:8,type:"minecraft:armor",operation:"add_value",slot:"chest"},{id:"minecraft:armor.chestplate",amount:2,type:"minecraft:armor_toughness",operation:"add_value",slot:"chest"}],"minecraft:max_damage":528,"minecraft:equippable":{slot:"chest",asset_id:"minecraft:leather",equip_sound:"minecraft:item.armor.equip_diamond"},"minecraft:lore":[{text:"Wet as a Guardian, tough",color:"dark_gray"},{text:"as ... those shiny stones.",color:"dark_gray"}],repairable:{items:["minecraft:obsidian","minecraft:prismarine_crystals"]},"!damage_resistant":{}}}}},{BaseID:"prismarine_leggings",Add:{id:"obsidian_shard",count:16,Text:"16x Obsidian Shard"},Result:{id:"prismaridian_leggings",Item:{id:"netherite_leggings",components:{"minecraft:dyed_color":1051938,"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color"]},"minecraft:custom_data":{TempModifier:-3,OverHydrate:true},item_model:"minecraft:leather_leggings","minecraft:item_name":"Prismaridian Leggings","minecraft:attribute_modifiers":[{id:"minecraft:armor.leggings",amount:6,type:"minecraft:armor",operation:"add_value",slot:"legs"},{id:"minecraft:armor.leggings",amount:2,type:"minecraft:armor_toughness",operation:"add_value",slot:"legs"}],"minecraft:max_damage":514,"minecraft:equippable":{slot:"legs",asset_id:"minecraft:leather",equip_sound:"minecraft:item.armor.equip_diamond"},"minecraft:lore":[{text:"Wet as a Guardian, tough",color:"dark_gray"},{text:"as ... those shiny stones.",color:"dark_gray"}],repairable:{items:["minecraft:obsidian","minecraft:prismarine_crystals"]},"!damage_resistant":{}}}}},{BaseID:"prismarine_boots",Add:{id:"obsidian_shard",count:16,Text:"16x Obsidian Shard"},Result:{id:"prismaridian_boots",Item:{id:"netherite_boots",components:{"minecraft:dyed_color":1051938,"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color"]},"minecraft:custom_data":{TempModifier:-3,OverHydrate:true},item_model:"minecraft:leather_boots","minecraft:item_name":"Prismaridian Boots","minecraft:attribute_modifiers":[{id:"minecraft:armor.boots",amount:3,type:"minecraft:armor",operation:"add_value",slot:"feet"},{id:"minecraft:armor.boots",amount:2,type:"minecraft:armor_toughness",operation:"add_value",slot:"feet"}],"minecraft:max_damage":496,"minecraft:equippable":{slot:"feet",asset_id:"minecraft:leather",equip_sound:"minecraft:item.armor.equip_diamond"},"minecraft:lore":[{text:"Wet as a Guardian, tough",color:"dark_gray"},{text:"as ... those shiny stones.",color:"dark_gray"}],repairable:{items:["minecraft:obsidian","minecraft:prismarine_crystals"]},"!damage_resistant":{}}}}}]
